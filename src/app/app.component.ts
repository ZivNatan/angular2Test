...
export class AppComponent implements OnInit{
  ...
  public static  carsArray =[
    ...
    {id:'9', name:'Ford-Mustang-GT', src:'../assets/images/images1.jpg',text:"READ_ME!!   angularCli, typeScript, bootstrap theme, responsive, http requests, routing, components, components nesting @input, pipes, filtering, sorting, pagination, imageGallery (auto load when scroll down) "},
